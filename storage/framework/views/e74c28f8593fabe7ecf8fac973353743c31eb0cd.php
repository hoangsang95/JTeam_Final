<div class="container main-header">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-3 logo">
                <a href="<?php echo e(url('/')); ?>"><img height="65" alt="DoGomBatTrang" src="assets/images/gom/logo.jpg" /></a>
            </div>
            <div class="col-xs-7 col-sm-8 col-md-7 header-search-box">
                <form class="form-inline" action="<?php echo e(url('search')); ?>" method="get" role="search">   
                      <div class="form-group input-serach">
                         
                          <input id="keys" type="text" name="tukhoa" placeholder="Sản phẩm cần tìm..." 
                                 <?php if(\Request::is('search')): ?>
                                 value="<?php echo e($tukhoa); ?>"
                                 <?php endif; ?> />
                      </div>
            ...
            <div class="col-xs-5 col-sm-3 col-md-2 group-button-header">
                ...
                <div class="btn-cart" id="cart-block">
                    <a title="My cart" href="<?php echo e(url('gio-hang')); ?>">Giỏ</a>
                    ...
                    <div class="cart-block">
                        <div class="cart-block-content">
                            ...
                            <div class="cart-buttons">
                                <a href="<?php echo e(url('gio-hang')); ?>" class="btn-check-out">Thanh toán</a>
                            </div>
                        </div>
                    </div>
                </div>
