        ...
        <div id="contact" class="page-content page-contact">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6" id="contact_form_map">
                    ...
                    <br>
                    <ul class="store_info">
                        <li><i class="fa fa-home"></i><?php echo e($about->About_Address); ?></li>
                        <li><i class="fa fa-phone"></i><span><?php echo e($about->About_Mobile); ?></span></li>
                        <li><i class="fa fa-envelope"></i>Email: <span><a href="mailto:<?php echo e($about->About_Email); ?>"><?php echo e($about->About_Email); ?></a></span></li>
                    </ul> 
