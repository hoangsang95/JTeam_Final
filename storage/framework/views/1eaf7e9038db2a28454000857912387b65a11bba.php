...
<?php endif; ?>
			...
			<form action="admin/supplies/supplies_add" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="Supplies_Name" placeholder="Nhập tên vật tư" value="<?php echo e(old('Supplies_Name')); ?>"/>
                                </div>
                                <div class="form-group">
                                    <label>Mô tả <span class="text-danger">*</span></label>
                                    <textarea rows="10" class="form-control" name="Supplies_Description" rows="3" value=""><?php echo e(old('Supplies_Description')); ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Số lượng</label>
                                    <input class="form-control" type="number" name="Supplies_Quantity" placeholder="Nhập số luông" value="<?php echo e(old('Supplies_Quantity')); ?>"/>
                                </div>
