    ...
    <div class="container-fluid">
        <div class="row" >
            ...
            <table class="table table-striped table-bordered table-hover " id="dataTables-example" >
                ...
                <tbody>
                    <?php $__currentLoopData = $warehouse_history_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="odd gradeX" align="center">

                        <td><?php echo e($r->Product_Name); ?></td>
                        <td><?php echo e($r->Warehouse_Count); ?></td>
                        <td><?php echo e($warehouse_history_user->User_Name); ?></td>
