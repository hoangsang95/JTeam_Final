            ...
            <div class="box-border">
                ...
                <ul>
                    ...
                    <li class="row">
                        ...
                        <div class="col-sm-6{{ $errors->has('Cart_Name') ? ' has-error' : '' }}">
                            
                            <label for="first_name_1" class="required">Họ tên</label>
                            <input class="input form-control" type="text" name="Cart_Name" id="first_name_1" value="{{old('Cart_Name')}}">
                            @if ($errors->has('Cart_Email'))
                        ...
                        <div class="col-sm-6{{ $errors->has('Cart_Mobile') ? ' has-error' : '' }}">
                            
                            <label for="last_name_1" class="required">Số điện thoại</label>
                            <input class="input form-control" type="text" name="Cart_Mobile" id="last_name_1" value="{{old('Cart_Mobile')}}">
                            @if ($errors->has('Cart_Email'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('Cart_Mobile')}}</strong>
                                </span>
                            @endif
                    ...
                    <li class="row">
                        ...
                        <div class="col-sm-6{{ $errors->has('Cart_Address') ? ' has-error' : '' }}">
                            
                            <label for="address_1" class="required">Địa chỉ</label>
                            <input class="input form-control" type="text" name="Cart_Address" id="address_1" value="{{old('Cart_Address')}}">
                             @if ($errors->has('Cart_Email'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('Cart_Address')}}</strong>
                                </span>
                            @endif

                        </div><!--/ [col] -->

                        <div class="col-sm-6{{ $errors->has('Cart_Email') ? ' has-error' : '' }}">
                            
                            <label for="email_address_1" >Email</label>
                            <input class="input form-control" type="text" name="Cart_Email" id="email_address_1" value="{{old('Cart_Email')}}">
                            @if ($errors->has('Cart_Email'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('Cart_Email')}}</strong>
                                </span>
                            @endif
